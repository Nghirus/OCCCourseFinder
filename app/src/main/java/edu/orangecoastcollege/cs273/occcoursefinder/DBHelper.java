...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        createQuery = "CREATE TABLE " + OFFERINGS_TABLE + "("
                ...
                + "FOREIGN KEY (" + FIELD_COURSE_ID + ")" + " REFERENCE " + COURSES_TABLE
                +"(" + COURSES_KEY_FIELD_ID + "),"
                + "FOREIGN KEY (" + FIELD_INSTRUCTOR_ID + ")" + " REFERENCE " + INSTRUCTORS_TABLE
    ...
    public void addOffering(Offering newOffering)
    {
        ...
        values.put(FIELD_CRN, newOffering.getCRN());
        values.put(FIELD_SEMESTER_CODE, newOffering.getSemesterCode());
        values.put(FIELD_COURSE_ID, newOffering.getCourse().getId());
        values.put(FIELD_INSTRUCTOR_ID, newOffering.getInstructor().getId());
    ...
    public ArrayList<Offering> getAllOffering()
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(OFFERINGS_TABLE, new String[]{FIELD_CRN, FIELD_SEMESTER_CODE, FIELD_COURSE_ID, FIELD_COURSE_ID},
        ...
        while (!cursor.isAfterLast())
        {
            Offering offering = new Offering(cursor.getInt(0),
                    cursor.getInt(1), getCourse(cursor.getInt(2)), getInstructor(cursor.getInt(3)));
    ...
    public void updateOffering(Offering newOffering)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        ...
        db.update(OFFERINGS_TABLE, values, OFFERINGS_TABLE + " = ?" ,
                new String[]{String.valueOf(newOffering.getCRN())});
    ...
    public Offering getOffering(long id)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(OFFERINGS_TABLE, new String[]{FIELD_CRN, FIELD_SEMESTER_CODE, FIELD_COURSE_ID, FIELD_COURSE_ID},
                FIELD_CRN + "= ?", new String[]{String.valueOf(id)} , null, null, null);
